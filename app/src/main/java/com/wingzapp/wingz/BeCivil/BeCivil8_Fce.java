...
public class BeCivil8_Fce extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_be_civil8__fce);

        sum18="1Zyo386GRQzynnnPhhL-_cdm7_gKKXXWS";
        sum19="1ZvdD8lv3Dgc7g_2DnMkv4i5yedhVlww-";
