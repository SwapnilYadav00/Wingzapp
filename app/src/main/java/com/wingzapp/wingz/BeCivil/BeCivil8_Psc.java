...
public class BeCivil8_Psc extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String sum17,sum18,sum19,win17;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_civil8__psc);

        sum17="1cIfrqc61AMnDVpL8PYXj_95x-i9Vf2FE";
        sum18="1cJG55xspVVCtIhmAmns0RiO--DkXI8Yc";
        sum19="1c79FyjS12bI1M3MUO4-ieN0klN1Xzw9w";
        win17="1cLIzE6dnsyV39ah0JgSQlP27G3cJFNAW";
