...
public class BeCivil8_Drmt extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String sum18,sum19,win18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_civil8__drmt);

        sum18="1ZXbAojsyDp7iOOsYWkAVYs7P8tVX6b1_";
        sum19="1ZV_VH7DoHfMbsGNaD-BaKalxVjISROAQ";
        win18="1ZWxrCkaNh9qPIOEGbsxtMOBUqcn163mq";
