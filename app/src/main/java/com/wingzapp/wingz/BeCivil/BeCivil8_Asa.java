...
public class BeCivil8_Asa extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String sum17,win16,win17;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_civil8__asa);

        sum17="16GB0WdyiAKxmUsbYzw4jWUFHesNm9lQl";
        win16="169sb-edCXX9Mp1qRXtnsszzscVARMcYW";
        win17="16GEAR4BP69FIswZFaaMXNVkBif8Ac_Dd";
