...
public class BeCivil8_Gigit extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String sum16,sum17,sum18,sum19,win16,win17;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_civil8__gigit);

        sum16 ="1ZIbwYGXlZw2XY5_Lg5iiMMZ6vBvzusQ1";
        sum17="1ZGufDsRRYTjXyM30RurkFP3xE2u3aIBR";
        sum18="1ZK6tmQSypFyac4Fo5DIVUoF7RDXsCxXm";
        sum19="1ZGWX7fQIBQ5Es5vNWTpMWQ2yZz04xCL3";
        win16="1ZUhpmyPTPtzkJqJ81jgtUoERmD4fC__g";
        win17="1ZTTHemsfIy14LVX2lBxlqCcCaWiRG293";
