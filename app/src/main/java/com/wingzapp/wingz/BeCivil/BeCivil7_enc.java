...
public class BeCivil7_enc extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String sum15,sum17,sum18,sum19,win15,win16,win17,win18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_civil7_enc);

        sum15 ="1SKjsnX01PLGgnCp3p5LamFwU24EC6X_2";
        sum17="1SR5YRYG7Hwlw7EvbdrK218juKROVA45d";
        sum18="1SRbcN_fTROda2yhiMmAY3nA4YcjqSUQA";
        sum19="1SHzH5P5w02I6_paaAKvU2igDLLRFzjZE";
        win15="1SM0HWntC87rfOjgZnlHAaCZk8bmeql5f";
        win16="1STzc1ITqps0i8H7lzqQMlL4reAAgZl3Z";
        win17="1SVg4t4NqlUcmZPlR1w93HySpjftfxfA_";
        win18="1SYcPK5BteHirhPI55BMSWOKSttrne0z0";
