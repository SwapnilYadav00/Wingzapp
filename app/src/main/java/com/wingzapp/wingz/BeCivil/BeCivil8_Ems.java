...
public class BeCivil8_Ems extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String sum17,sum18,sum19,win17,win18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_civil8__ems);


        sum17="1aLP_W_C9_ja1hRBJFU5O0qGxEj9e_esM";
        sum18="1aKErK4dFHA35CsNP_KbQSuXi5nb95BgO";
        sum19="1aAkeiC-t6m4mkCUDJASli8cArQWbre9-";
        win17="1aOEodrEtaiUw9u7sfDyLZ45E0ZA_z9iR";
        win18="1aUu2gBPS5CjXmzTlLQ6i37xXCkOF7ye2";
