...
public class BeCivil3_Geology extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;

    String sum18,sum19,sum16,sum15,sum17,win17,win18,win15,win16,win19;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_civil3__geology);

        sum19="15vQz7M-XmHAy5Tf0PlVA_qkPNYf_OKXd";
        sum18="164C2MUGQB--RbIpBLtz7yO8XoDNxk4Nt";
        win17="163fKT1jWAkcW8Odfbd1K2GhAPoEWLBB-";
        win18="15wddTJ_hu1XGbF3gfprdqSmPTse3TKZL";
        sum15 = null; sum16 = null;sum17 = null;
        win15 = null; win16 = null;win19 = null;
