...
public class BeExtc8_Ai extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String sum18,win16,win17;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_extc8__ai);

        sum18="1EeqnDBchDhmNKXKam2z875_c4giGEJw0";
        win16="1EfR5WWV3yP_6bknLOc210WSJD7on4v1W";
        win17="1EeHdK6LBAd1Gcw396zEjpKnhrl07vhUI";
