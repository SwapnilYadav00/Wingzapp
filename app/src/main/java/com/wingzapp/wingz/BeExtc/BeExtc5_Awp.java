...
public class BeExtc5_Awp extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String sum17,sum18,win16,win18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_extc5__awp);

        sum17="1eEjSCEzrxomgI_FqryJ1BDDs5HaJbsi1";
        sum18="1dXn-8z3wpD00WvMJoMhfxCCvGeVGM-jG";
        win16="1dxCVWC80Eu9ql__gelbFbC6LWKRSRln1";
        win18="1dxAHElQd-Y_6zbxuJN7i5r9dF0pHLO8S";
