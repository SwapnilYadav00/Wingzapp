...
public class BeExtc4_Dcfm extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String sum17,sum18,sum19,win15,win16,win17,win18,win19;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_extc4__dcfm);

        sum17="1GqtenGLsjDOe9sfGMOT-AXTnFimhv_91";
        sum18="1GbqxrGD1rkGQddK17l1F_-lgt6ZPTVK-";
        sum19="1GfBx_aM2yxYekzYsEJIGMWUpKCulh35o";
        win16="1GzTzu6Uyr5XsWkOZ-junwiHHuEHAoWqD";
        win17="1Gsp630-YbtN6YaUxdeQpwaxGKyeupWA0";
        win18="1GbqxrGD1rkGQddK17l1F_-lgt6ZPTVK-";
        win19="1GRPMU33ZsvkdA7LFAgpFiO3X0AnSg59U";
