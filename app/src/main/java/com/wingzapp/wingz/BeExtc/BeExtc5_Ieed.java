...
public class BeExtc5_Ieed extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String sum17,sum18,win16,win17,win18;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_extc5__ieed);

        sum17="1L7iEubzkxzr9Aw5gbv-JF0nitIfL_U8E";
        sum18="1KntbjpwshQBdHi0IkCqDQ2DZfs1Xxhp9";
        win16="1L2egci6hETYXojv_8nb2jywqJMpg5EjE";
        win17="1LGbJB-2DYmg6WDsE-NtYAI_zE8pWZUzG";
        win18="1Kq-7jagsIf_ZPnhksAnNaGyHtxV6wLSH";
