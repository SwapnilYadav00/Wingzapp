...
public class BeExtc8_Wsn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_be_extc8__wsn);

        sum17="1GPybo9o-dKOTKUr4JmXBcm-rJRxfME0v";
        sum18="1GMPi6VC_Bhchp8fHzJLwbrYTjL3htnF0";
        win16="1GNC9y9X6T2Q7JFadvzxZFyV5xHBoj_Hs";
        win17="1GMSWsnyIgVARMjWpge9_-MUNM5hJ-TjM";
