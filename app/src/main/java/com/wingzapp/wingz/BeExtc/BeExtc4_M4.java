...
public class BeExtc4_M4 extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String sum16,sum17,sum18,sum19,win16,win17,win18,win19;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_extc4__m4);

        sum16="1HeLAt-Qk16yyjfcHZAjBtGb7SKgHG_k9";
        sum17="1HfMT-XunH6R8ux5CDj2jCM3PbwEtuuB1";
        sum18="1HOqfp2mnFGLsnpT5o3XBfw5IazUGZacS";
        sum19="1HQOSLQGfXv3isPcKZ7UWKm8rZDKc4jEu";
        win16="1HfOcKB6A7973cqUdJ-cf-heQIT0maBcc";
        win17="1HgAJmMTMsNdlq3B_PPjCbdcTkTHfiz8D";
        win18="1HWbQ1Agk6rSr8NwhkgbZetHFLEBy_rW0";
        win19="1HNJNmWPzTe4pQ6Ub4kHexl_Q0oK0xu3m";
        ...
        w19.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.setVisibility(View.VISIBLE);
                cardView.setVisibility(GONE);
                webView.loadUrl("https://drive.google.com/viewerng/viewer?embedded=true&url=https://drive.google.com/u/1/uc?id="+win19+"&export=download");
