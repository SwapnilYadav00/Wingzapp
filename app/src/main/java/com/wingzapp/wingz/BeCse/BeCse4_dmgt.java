...
public class BeCse4_dmgt extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private String win18,sum16,sum18,win15,win16,win17;
    private ProgressBar progressBar;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_cse4_dmgt);

        win18="13ROyAs3pZzOJqltFGLIuh_nvjDDAXTj_";
        sum18="13YVg9ExCq75Vme2h3JKtHGSkhU5jxcM6";
        win17="13cWc_dRPjjoWuEB_TGR7GFspH8HKoHwT";
        win16="13TmJHKI59lXDO1tojCe4UJDbCsThtrGx";
        sum16="13P18ZROIAfczGHBSyM1-L_krziEs_YAp";
        win15="13L7z2o9d-p5kniRDoI8pJCbbcvGINcf5";
