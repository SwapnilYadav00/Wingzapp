...
public class BeCse4_tfcs extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private String win15,sum17,sum18,win18,win16,win17,sum16;
    private ProgressBar progressBar;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_cse4_sp);

        win18="14KLBkmpLfZ2CjiOZ48_U7r0sHjnZSOib";
        sum18="14GLdLAAjj-5kAse-JzJB2PYk5zuNFRZV";
        win17="14R8xhB26rVShTkDmNobBagwpHRNJ2cVu";
        sum17="14ViRiAquLbVBm1JR0_3h0ZKYbEVadDkG";
        win16="14L412vTtnZFk2D97FNqgj0LhBAF748Uy";
        sum16="14EGuSvarfjDdZEys54_O64jvfyZ2d2RW";
        win15="14BIMLJq2tHIrjXIj3JvwaFywSu6BuOWs";
